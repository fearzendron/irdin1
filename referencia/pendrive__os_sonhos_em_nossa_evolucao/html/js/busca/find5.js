...
var find_window_border = "purple"; // the border color of pop-up window
...
// This part creates the instructions and the "find" button
	...
	+ ' onchange="resettext();" placeholder="Clique aqui e digite">'
	+ '<input type="button" style="border: 1px solid #777777; background: purple; color: #F7F5EF; -moz-border-radius: 4px; -webkit-border-radius: 4px;" value="Anterior" onclick="findprev();">&nbsp;'
	+ '<input id="btn" type="button" style="border: 1px solid #777777; background: purple; color: #F7F5EF; -moz-border-radius: 4px; -webkit-border-radius: 4px;" value="Pr&oacute;xima" onclick="this.blur(); findit();">' // ver 5.3 - 5/15/2015 - added this.blur();
...
document.write('<div align="center"><input type="button" style="border: 1px solid #777777; background: purple; color: #F7F5EF; padding: 4px; font: bold 21px \'ubuntu\'; -moz-border-radius: 4px; -webkit-border-radius: 4px;" value="Clique aqui para procurar palavras"' + ' onclick="show();">' + "</div>");
